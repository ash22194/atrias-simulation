...
sm.lowerleg_13_foot = 0.49;
% Foot
sm.d_foot_point_front = [0.06350 -0.02515 0];
sm.d_foot_point_back = [-0.06350 -0.02515 0];
sm.m_foot = 0.0857;
sm.com_foot = [0 -0.00959 0];
sm.i_foot_moments = [0.00001 0.00006 0.00006];
sm.i_foot_products = [0 0 0];
sm.ankle_stiffness = 1/2*pi;
sm.ankle_equilibrium = 25*pi/180;
% Four Bar Link
...
sm.initial_torso_yaw = 0*pi/180;
sm.initial_torso_pitch = 0*pi/180;
sm.initial_torso_roll = 0*pi/180;
sm.initial_pitch_joint_height = sm.initial_com_height + sm.boom_mount_to_com;
